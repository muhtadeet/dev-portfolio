...
export default function FooterWithLogo() {
  return (
    <footer className="w-full bg-gray-900 mt-10 p-14">
      <div className="flex flex-row flex-wrap items-center justify-center gap-y-6 gap-x-64 text-center">
        <b className="text-white font-ubuntu text-xl">Muhtadee Taron</b>
        <ul className="flex flex-col sm:flex-row flex-wrap items-center gap-y-2 gap-x-10">
          <li>
            ...
            <svg
              ...
              className="tabler-icon tabler-icon-brand-linkedin transition ease-in-out hover:stroke-light-blue-600 hover:animate-bounce stroke-gray-100"
            >
          ...
          <li>
            ...
            <svg
              ...
              strokeLinecap="round"
              strokeLinejoin="round"
              className="transition ease-in-out hover:stroke-light-blue-600 hover:animate-bounce stroke-gray-100 tabler-icon tabler-icon-brand-github"
            >
